...
<template>
  ...
  >
      ...
      <VCardText class="app-bar-search-suggestions pa-12">
        <VRow v-if="suggestionGroups">
          <VCol v-for="suggestion in suggestionGroups" :key="suggestion.title" cols="12" sm="6">
            <p
              class="custom-letter-spacing text-disabled text-uppercase mb-0 px-4 py-2"
    ...
    <template #noDataSuggestion>
      <div class="mt-9">
        <span class="d-flex text-disabled mb-2 justify-center">Try searching for</span>
        <h6
          v-for="suggestion in noDataSuggestions"
          :key="suggestion.title"
          class="app-bar-search-suggestion text-h6 font-weight-regular cursor-pointer px-4 py-2"
