...
<template>
  ...
  >
    <VSlideGroupItem v-for="(item, index) in props.items" :key="item.title" :value="index">
      <div
        class="app-stepper-step pa-1 cursor-pointer"
        :class="[
      ...
      >
        ...
        <template v-if="item.icon">
          <div class="stepper-icon-step text-high-emphasis d-flex align-center">
            <!-- 👉 icon and title -->
            <div
              class="d-flex align-center step-wrapper gap-x-3"
        ...
        <template v-else>
          <div class="d-flex align-center gap-x-3">
            ...
            <div class="d-flex flex-column justify-center">
              ...
              <div v-if="item.subtitle" class="stepper-subtitle text-disabled text-sm">
                {{ item.subtitle }}
              </div>
            </div>
