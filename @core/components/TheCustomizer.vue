...
<template>
  <div class="d-lg-block d-none">
    <VBtn
      icon
      class="app-customizer-toggler rounded-0 rounded-s-lg"
      style="z-index: 1001"
        ...
        >
          ...
          <div class="d-flex flex-column gap-2">
            ...
            >
              ...
              <div
                class="primary-color-wrapper d-flex align-center cursor-pointer"
                style="
                  border-radius: 0.375rem;
                  outline: 1px solid rgba(var(--v-border-color), var(--v-border-opacity));
                  padding-block: 0.5rem;
          ...
          <div class="d-flex flex-column gap-2">
            ...
            >
              <template #label="item">
                <span class="text-medium-emphasis mt-1 text-sm">{{ item?.label }}</span>
              </template>

              <template #content="{ item }">
                <div
                  class="customizer-skins-icon-wrapper d-flex align-center w-100 justify-center py-3"
          ...
          <div class="d-flex flex-column gap-2">
            ...
            >
              <template #label="item">
                <span class="text-medium-emphasis text-sm">{{ item?.label }}</span>
              </template>
            </CustomRadiosWithImage>
          </div>
