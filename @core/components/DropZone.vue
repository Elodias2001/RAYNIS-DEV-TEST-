    ...
    <div class="relative h-auto w-full">
      <div ref="dropZoneRef" class="cursor-pointer" @click="() => open()">
        <div
          ...
          class="d-flex flex-column align-center pa-12 drop-zone justify-center gap-y-2 rounded"
        >
        ...
        <div v-else class="d-flex align-center pa-8 drop-zone flex-wrap justify-center gap-3">
