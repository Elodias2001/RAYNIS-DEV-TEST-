        ...
        >
          ...
          <template #append-inner>
            <div class="d-flex align-start">
              <div
                class="text-disabled me-3 cursor-pointer text-base"
          ...
          <div v-show="!props.searchResults.length && searchQueryLocal.length" class="h-100">
            <slot name="noData">
              <VCardText class="h-100">
                <div
                  class="app-bar-search-suggestions d-flex flex-column align-center text-high-emphasis pa-12 justify-center"
                >
                  <VIcon size="64" icon="tabler-file-alert" />
                  <div class="d-flex align-center text-h5 mt-3 flex-wrap justify-center gap-2">
