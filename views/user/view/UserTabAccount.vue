    ...
    <VCol cols="12">
      <VCard>
        <VCardText class="d-flex justify-space-between align-center flex-wrap gap-4">
          <h5 class="text-h5">User's Projects List</h5>
            ...
            <div class="d-flex">
              <div class="v-avatar-group">
                ...
                <VAvatar
                  ...
                  :size="26"
                >
                  <div class="text-caption text-high-emphasis">+{{ item.extraMembers }}</div>
                </VAvatar>
              </div>
            </div>
          </template>
        ...
        <VCardText>
          ...
          >
              ...
              <div class="d-flex justify-space-between align-center flex-wrap">
                ...
                <div class="d-flex align-center mt-2">
                  ...
                  <div class="d-flex flex-column">
                    <p class="font-weight-medium text-medium-emphasis mb-0 text-sm">
            ...
            <VTimelineItem size="x-small" dot-color="info">
              ...
              <!-- 👉 Content -->
              <p class="app-timeline-text mb-2 mt-1">6 team members in a project</p>
