...
<template>
  <VRow>
        ...
        <VCardText>
          <VList class="card-list">
            ...
            >
              ...
              <template #append>
                <VSwitch v-model="account.connected" density="compact" class="me-1" />
              </template>
            </VListItem>
          </VList>
        </VCardText>
    ...
    <!-- 👉 social accounts -->
    <VCol cols="12">
      <VCard title="Social Accounts" subtitle="Display content from social accounts on your site">
        <VCardText>
          <VList class="card-list">
            <VListItem v-for="account in socialAccounts" :key="account.title">
              ...
              <template #prepend>
                <VAvatar start size="36" rounded="0" class="me-1" :image="account.img" />
              </template>
