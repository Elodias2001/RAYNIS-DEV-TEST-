        ...
        <VCardText>
          <VRow>
            <VCol cols="12" md="6" order-md="1" order="2">
              <h6 class="text-h6 mb-1">Your Current Plan is Basic</h6>
              <p>A simple start for everyone</p>

              <h6 class="text-h6 mb-1">Active until Dec 09, 2021</h6>
            ...
            <VCol cols="12" md="6" order-md="2" order="1">
              ...
              <VAlert color="warning" variant="tonal">
                ...
                <div class="text-base">Your plan requires update</div>
              </VAlert>

              <!-- 👉 Progress -->
              <div class="d-flex justify-space-between font-weight-bold mb-2 mt-4">
                <h6 class="text-h6">Days</h6>
                <h6 class="text-h6">26 of 30 Days</h6>
              </div>

              <VProgressLinear rounded color="primary" :height="10" :model-value="75" />
              <p class="mt-1 text-sm">Your plan requires update</p>
            </VCol>

            <VCol cols="12" order="3">
              <div class="d-flex flex-wrap gap-4">
                <VBtn @click="isUpgradePlanDialogVisible = true"> upgrade plan </VBtn>
      ...
      <VCard title="Payment Methods">
        ...
        <VCardText class="d-flex flex-column gap-y-4">
          <VCard v-for="card in creditCards" :key="card.name" border flat>
            <VCardText class="d-flex flex-sm-row flex-column justify-space-between gap-6">
              <div class="text-no-wrap">
                <img :src="card.image" :height="25" />
                <div class="d-flex align-center my-2 gap-x-2">
                  <h6 class="text-h6">
                    {{ card.name }}
                  </h6>
                  <VChip
              ...
              <div class="d-flex flex-column text-sm-end gap-y-4">
                <div class="order-sm-0 order-1">
                  <VBtn variant="tonal" size="small" class="me-4" @click="openEditCardDialog(card)">
                    Edit
                  </VBtn>
                  <VBtn color="error" variant="tonal" size="small"> Delete </VBtn>
                </div>

                <div class="order-sm-1 order-0 text-sm">Card expires at {{ card.expiry }}</div>
              </div>
            </VCardText>
          </VCard>
        </VCardText>
          ...
          <VRow>
            ...
            <VCol cols="12" lg="6">
              <VTable class="billing-address-table">
                ...
                <tr>
                  <td>
                    <h6 class="text-h6 text-no-wrap mb-2">Zip Code:</h6>
                  </td>
                  <td>
                    <p class="text-body-1 mb-2">
