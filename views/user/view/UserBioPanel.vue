  ...
  <VRow>
    ...
    <VCol cols="12">
      <VCard v-if="props.userData">
        <VCardText class="pt-12 text-center">
          <!-- 👉 Avatar -->
          <VAvatar
            rounded
            :size="100"
          ...
          >
            ...
            <span v-else class="font-weight-medium text-5xl">
        ...
        <VCardText>
          <div class="d-flex justify-space-around mb-6 flex-wrap gap-x-6 gap-y-2">
            <!-- 👉 Done task -->
        ...
        <VCardText class="d-flex justify-center gap-x-4">
          <VBtn variant="elevated" @click="isUserInfoEditDialogVisible = true"> Edit </VBtn>
    ...
    <VCol cols="12">
      <VCard>
        <VCardText class="d-flex">
          <!-- 👉 Standard Chip -->
          <VChip label color="primary" size="small" class="font-weight-medium"> Popular </VChip>

          <VSpacer />

          <!-- 👉 Current Price  -->
          <div class="d-flex align-center">
            <sup class="text-h5 mt-1 text-primary">$</sup>
        ...
        <VCardText>
          ...
          <div class="d-flex gap-4">
            <VBtn block @click="isUpgradePlanDialogVisible = true"> Upgrade Plan </VBtn>
          </div>
        </VCardText>
      </VCard>
    </VCol>
