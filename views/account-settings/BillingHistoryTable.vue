...
<template>
  <VCard v-if="invoices" id="invoice-list" title="Billing History">
    <VCardText class="d-flex align-center flex-wrap gap-4">
      ...
      <VBtn prepend-icon="tabler-plus" :to="{ name: 'apps-invoice-add' }"> Create invoice </VBtn>
      ...
      <template #item.client="{ item }">
        <div class="d-flex align-center">
          ...
          <div class="d-flex flex-column">
            <NuxtLink
              class="font-weight-medium text-body-1 text-high-emphasis text-link mb-0"
