          ...
          <VRow>
            <VCol cols="12" md="6">
              <div>
                <div class="mb-6">
                  ...
                  <p class="text-body-1">A simple start for everyone</p>
                </div>
                ...
                <div>
                  ...
                  <p class="mb-0 text-base">Standard plan for small to medium businesses</p>
                </div>
              </div>
            </VCol>
            ...
            <VCol cols="12" md="6">
              <VAlert icon="tabler-alert-triangle" type="warning" variant="tonal">
                <VAlertTitle class="mb-1"> We need your attention! </VAlertTitle>

                <span>Your plan requires update</span>
              </VAlert>

              <!-- progress -->
              <h6 class="d-flex font-weight-medium text-body-1 text-high-emphasis mb-1 mt-6">
                <span>Days</span>
                <VSpacer />
              ...
              <p class="text-body-2 mb-0 mt-1">18 days remaining until your plan requires update</p>
            </VCol>

            <VCol cols="12">
              <div class="d-flex flex-wrap gap-4">
                <VBtn @click="isPricingPlanDialogVisible = true"> upgrade plan </VBtn>
        ...
        <VCardText>
          <VForm @submit.prevent="() => {}">
            <VRow>
              ...
              <!-- 👉 Saved Cards -->
              <VCol cols="12" md="6">
                <h6 class="text-body-1 text-high-emphasis font-weight-medium mb-6">My Cards</h6>
                  ...
                  >
                    <VCardText class="d-flex flex-sm-row flex-column">
                      <div class="text-no-wrap">
                        ...
                        <h4 class="text-body-1 text-high-emphasis d-flex align-center my-2">
                          <div class="font-weight-medium me-4">
                            {{ card.name }}
                          </div>
                      ...
                      <div class="d-flex flex-column text-sm-end">
                        <div class="d-flex order-sm-0 order-1 flex-wrap gap-4">
                          <VBtn variant="tonal" size="small" @click="openEditCardDialog(card)">
                            Edit
                          </VBtn>
                          <VBtn color="error" size="small" variant="tonal"> Delete </VBtn>
                        </div>
                        <span class="text-body-2 order-sm-1 order-0 my-4"
        ...
        <VCardText>
          <VForm @submit.prevent="() => {}">
            <VRow>
              <!-- 👉 Company name -->
              <VCol cols="12" md="6">
                <AppTextField label="Company Name" placeholder="Pixinvent" />
              </VCol>

              <!-- 👉 Billing Email -->
              <VCol cols="12" md="6">
                <AppTextField label="Billing Email" placeholder="pixinvent@email.com" />
              </VCol>
              ...
              <VCol cols="12" class="d-flex flex-wrap gap-4">
                <VBtn type="submit"> Save changes </VBtn>
                <VBtn type="reset" color="secondary" variant="tonal"> Discard </VBtn>
              </VCol>
            </VRow>
          </VForm>
        </VCardText>
