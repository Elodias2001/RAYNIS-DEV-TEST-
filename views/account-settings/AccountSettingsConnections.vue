...
<template>
  <VCard>
    <VRow>
      <VCol cols="12" md="6" class="pe-md-0 pb-md-3 pb-0">
        <!-- 👉 Connected Accounts -->
        <VCard
        ...
        >
          <VCardText>
            <VList class="card-list">
              <VListItem v-for="item in connectedAccounts" :key="item.logo">
                <template #prepend>
                  <VAvatar start>
                    <img :src="item.logo" height="32" />
                  </VAvatar>
                </template>
                <VListItemTitle>
                  <h6 class="text-h6">
                ...
                <template #append>
                  <VListItemAction>
                    <VSwitch v-model="item.connected" density="compact" class="me-1" />
                  </VListItemAction>
                </template>
              </VListItem>
            </VList>
      ...
      <VCol cols="12" md="6" class="ps-md-0 pt-md-3 pt-0">
        <!-- 👉 Social Accounts -->
        <VCard
          ...
          <VCardText>
            <VList class="card-list">
              <VListItem v-for="item in socialAccounts" :key="item.logo">
                ...
                <VListItemSubtitle v-else class="text-xs"> Not Connected </VListItemSubtitle>
                <template #append>
                  <VListItemAction>
                    <IconBtn
                      variant="tonal"
                      ...
                      class="rounded"
                    >
                      <VIcon size="22" :icon="item.connected ? 'tabler-trash' : 'tabler-link'" />
                    </IconBtn>
                  </VListItemAction>
                </template>
              </VListItem>
