            ...
            <VCardText class="pt-1">
              <VForm @submit.prevent="() => {}">
                <VRow>
                  ...
                  <!-- 👉 Name the API Key -->
                  <VCol cols="12">
                    <AppTextField label="Name the API key" placeholder="Name the API key" />
                  </VCol>
        ...
        <VCardText class="d-flex flex-column gap-y-6">
          ...
          >
            <div class="d-flex flex-column gap-y-2">
              ...
              <div class="d-flex align-center font-weight-medium text-base">
              ...
              <div class="text-disabled">Created on {{ serverKey.createdOn }}</div>
            </div>
          </VCard>
        </VCardText>
      </VCard>
