  ...
  <VCard>
    <VCardText>
      <div class="d-flex align-center justify-space-between">
        <div class="text-body-1">Sales Overview</div>
        <div class="text-success font-weight-medium">+18.2%</div>
      </div>
      ...
      <VRow no-gutters>
        <VCol cols="5">
          <div class="py-2">
            ...
            <h5 class="text-h5">62.2%</h5>
            <div class="text-body-2 text-disabled">6,440</div>
          </div>
        </VCol>
        ...
        <VCol cols="5" class="text-end">
          <div class="py-2">
            <div class="d-flex align-center mb-3 justify-end">
            ...
            <div class="text-body-2 text-disabled">12,749</div>
          </div>
        </VCol>
      </VRow>
