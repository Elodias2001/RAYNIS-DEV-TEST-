...
<template>
  ...
  >
    ...
    <VCard class="pa-2 pa-sm-10">
      <VCardText>
        <!-- 👉 Title -->
        <h4 class="text-h4 mb-2 text-center">Select Payment Providers</h4>
        <p class="text-body-1 mb-6 text-center">Third-party payment providers</p>

        <div v-for="(item, index) in paymentProvidersData" :key="index">
          <div class="d-flex flex-column flex-sm-row justify-space-between flex-wrap gap-4 py-4">
            <h6 class="text-h6">
              {{ item.title }}
            </h6>
