    ...
    <VCard class="pa-2 pa-sm-10">
      <VCardText>
        ...
        <VForm>
          ...
          >
            <template #text>
              By {{ props.permissionName ? "editing" : "adding" }} the permission name, you might
              break the system permissions functionality.
            </template>
          </VAlert>

          <!-- 👉 Role name -->
          <div class="d-flex flex-column flex-sm-row mb-6 flex-wrap gap-4">
            <AppTextField
