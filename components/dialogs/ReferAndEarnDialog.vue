...
<template>
  ...
  >
    ...
    <VCard class="pa-2 pa-sm-10">
      <VCardText>
        <h4 class="text-h4 mb-2 text-center">Refer & Earn</h4>
        <p class="text-body-1 mb-6 text-center">
          Invite your friend to <span class="text-capitalize">{{ themeConfig.app.title }}</span
          >, if they sign up, you and your friend will get 30 days free trial
        </p>

        <VRow class="mt-8 text-center">
