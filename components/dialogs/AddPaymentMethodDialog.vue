...
<template>
  ...
  >
    ...
    <VCard class="pa-2 pa-sm-10">
      <VCardText>
        <!-- 👉 Title -->
        <h4 class="text-h4 mb-2 text-center">Add payment methods</h4>
        <p class="text-body-1 mb-6 text-center">Supported payment methods</p>

        <div v-for="(item, index) in paymentMethodsData" :key="index">
          <div class="d-flex justify-space-between align-center gap-x-4 py-4">
