  ...
  >
    ...
    <VCard class="create-app-dialog" min-height="590">
      <VCardText class="pa-5 pa-sm-16">
        <!-- 👉 Title -->
        <h4 class="text-h4 mb-2 text-center">Create App</h4>
        <p class="text-body-1 mb-6 text-center">Provide data with this form to create your app.</p>
          ...
          <VCol cols="12" sm="7" md="8" lg="9">
            <VWindow v-model="currentStep" class="disable-tab-transition stepper-content">
              ...
              <VWindowItem>
                ...
                <h5 class="text-h5 mb-4 mt-6">Select Database Engine</h5>
              ...
              <VWindowItem class="text-center">
                ...
                <p class="mb-4 text-sm">Submit to kickstart your project.</p>
