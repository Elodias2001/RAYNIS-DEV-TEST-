...
<template>
  ...
  >
    ...
    <VCard class="share-project-dialog pa-2 pa-sm-10">
      <VCardText>
        <h4 class="text-h4 mb-2 text-center">Share Project</h4>
        <p class="text-body-1 mb-6 text-center">Share project with a team members</p>
        ...
        <div
          class="d-flex align-center justify-sm-space-between mt-6 flex-wrap justify-center gap-3"
        >
          ...
          <VBtn class="text-capitalize" prepend-icon="tabler-link"> Copy Project Link </VBtn>
        </div>
      </VCardText>
    </VCard>
  </VDialog>
