...
<template>
  ...
  >
    ...
    <VCard class="pa-2 pa-sm-10">
      <VCardText>
        <!-- 👉 Title -->
        <h4 class="text-h4 mb-2 text-center">Upgrade Plan</h4>
        <p class="text-body-1 mb-6 text-center">Choose the best plan for user.</p>
        ...
        <div class="d-flex justify-space-between flex-column flex-sm-row gap-4">
          <AppSelect
            ...
            placeholder="Basic"
          />
          <VBtn class="align-self-end" :block="$vuetify.display.xs"> Upgrade </VBtn>
        </div>
        ...
        <div class="d-flex justify-space-between align-center flex-wrap">
          <div class="d-flex align-center me-3 gap-1">
