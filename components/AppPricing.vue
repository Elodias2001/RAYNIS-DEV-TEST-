...
<template>
  ...
  <div class="d-flex font-weight-medium text-body-1 align-center mx-auto mb-6 mt-12 justify-center">
    ...
    <div class="position-relative">
      ...
      <div class="save-upto-chip position-absolute align-center d-none d-md-flex gap-1">
        <VIcon icon="tabler-corner-left-down" size="24" class="flip-in-rtl text-disabled mt-2" />
    ...
    <VCol v-for="plan in pricingPlans" :key="plan.logo" v-bind="props" cols="12">
      ...
      <VCard flat border :class="plan.isPopular ? 'border-primary border-opacity-100' : ''">
        ...
        <VCardText>
          ...
          <div class="position-relative">
            <div class="d-flex justify-center pb-10 pt-5">
